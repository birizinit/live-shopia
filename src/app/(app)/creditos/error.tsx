 ...
 * o `digest`. O que vale dizer com certeza e o que NAO aconteceu — o saldo esta
 * na razao de lancamentos e nao depende desta tela ter conseguido desenhar.
 */
export default function ErroCreditos({
  error,
  reset,
}: {
  ...
  return (
    <>
      <PageHeader titulo="Créditos" />

      <Card>
        <CardTitulo>Não deu para carregar o saldo</CardTitulo>
        <CardDescricao>
          O saldo, o extrato e a vitrine de pacotes vêm do banco, e a leitura
          falhou agora.
        </CardDescricao>

        <Alerta tom="info" className="mt-4">
          Seu saldo está guardado na razão de lançamentos e continua intacto.
          Nenhuma compra foi aberta e nada foi debitado.
        </Alerta>
